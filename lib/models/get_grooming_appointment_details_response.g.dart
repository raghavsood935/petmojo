...
_$_GetBookingDetailsResponse _$$_GetBookingDetailsResponseFromJson(
    ...
    _$_GetBookingDetailsResponse(
      ...
      sessionDetails: json['sessionDetails'] == null
          ? null
          : GroomingSessionDetails.fromJson(
...
_$_GroomingSessionDetails _$$_GroomingSessionDetailsFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_GroomingSessionDetailsToJson(
        _$_GroomingSessionDetails instance) =>
    <String, dynamic>{
