              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Assets.images.icAaText
                            .svg(width: 24, height: 24, color: Colors.white),
                        SizedBox(height: 8),
                        Assets.images.icFilterFace
                            .svg(width: 24, height: 24, color: Colors.white),
                        SizedBox(height: 8),
                        Assets.images.icFilterColor
                            .svg(width: 24, height: 24, color: Colors.white),
                        SizedBox(height: 8),
                        Assets.images.icFilterCrop
                            .svg(width: 24, height: 24, color: Colors.white),
                        SizedBox(height: 8),
                        Assets.images.icExpand
                            .svg(width: 24, height: 24, color: Colors.white),
                      ],
                    ),
                  ),
                ...
                Row(
                  children: [
                    ...
                    Assets.images.icRotateCamera.svg(
                      color: Colors.white,
                      width: 30,
                      height: 30,
                    ),
