...
class CreateAnimalProfileNewPageOne extends StatefulWidget {
  CreateAnimalProfileNewPageOne({Key? key, this.isFromStart}) : super(key: key);
...
class _CreateAnimalProfileNewPageOneState
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<CreateAnimalProfileNewPageOneViewModel>.reactive(
      onModelReady: (model) => model.init(widget.isFromStart ?? false),
      builder: (context, model, child) => WillPopScope(
        onWillPop: () =>
            (widget.isFromStart ?? false) ? model.skip() : model.onBack(),
        child: Scaffold(
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          ...
                          bottom: 0,
                          child: Visibility(
                            visible: !(widget.isFromStart ?? false),
                            child: IconButton(
