...
class MatingViewModel extends BaseModel {
  ...
  List<MatingAnimalProfile> _listOfStaryAnimals = [];
  ...
  Future init() async {
    for (int i = 0; i < 5; i++) {
      _listOfStaryAnimals.add(MatingAnimalProfile());
  ...
  List<MatingAnimalProfile> get listOfStaryAnimals => _listOfStaryAnimals;
