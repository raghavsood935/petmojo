...
import 'past_appointments_viewmodel.dart';

class MyPastAppointmentsView extends StatelessWidget {
  const MyPastAppointmentsView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MyPastAppointmentsViewModel>.reactive(
      ...
      viewModelBuilder: () => MyPastAppointmentsViewModel(),
    );
  }
}
