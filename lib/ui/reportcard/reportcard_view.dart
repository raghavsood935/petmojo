...
import 'package:tamely/ui/reportcard/reportcard_viewmodel.dart';
...
class ReportCardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ReportCardViewModel>.reactive(
      viewModelBuilder: () =>
          ReportCardViewModel(noOfDogs, dogs, date, walkNumber, appointmentId),
